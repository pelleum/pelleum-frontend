...
const SignupScreen = ({ navigation }) => {
    ...
    // Clear error message when navigating to/from SignupScreen
    useEffect(() => {
    ...
    // Opens links to web pages, like our Terms of Service and Privacy Policy
    ...
    // Triggered when Sign Up button is pressed
